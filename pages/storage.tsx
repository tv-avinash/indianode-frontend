export default function StoragePage() {
  ...
  return (
    <main className="mx-auto max-w-3xl p-6 leading-7">
      ...
      <p>Fast same-host storage for checkpoints, HF snapshots, and preprocessed data.</p>
      ...
      <p className="mt-2 text-sm opacity-80">Request the size you want in your SDL. Volume mounts at <code>/data</code>.</p>
      ...
      <pre className="bg-gray-100 p-3 rounded-md overflow-auto"><code>curl -fsSL {`${
        base || "https://your-backend.example.com"
      }/storage/preload.sh`} | bash</code></pre>
